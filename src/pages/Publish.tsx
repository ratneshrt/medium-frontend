        ...
        <>
            ...
            <div className="flex justify-center w-full pt-8">
                <div className="max-w-screen-lg w-full">
                    ...
                    }} type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center">
                        Publish post
                    </button>
                </div>
            </div>
