...
export const BlogCard = ({ authorName, title, content, publishedDate,id }: BlogCardPorps) =>{
    ...
    return ( <Link to={`/blog/${id}`}>
            <div className="p-4 border-b border-slate-200 pb-4 w-screen max-w-screen-md cursor-pointer">
                <div className="flex">
                    ...
                    <div className="flex justify-center flex-col pl-2 font-thin text-slate-700 text-sm">
                        {publishedDate}
                    </div>
                </div>
